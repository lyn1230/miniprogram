 ...
 */
var jsfeat = require("./jsfeat-min.js");
var FeatTrainer =  (function () {
  ...
  FeatTrainer.prototype.getGrayScaleMatPatten = function (img,w,h) {
  ...
  FeatTrainer.prototype.getGrayScaleMatRecog = function (w, h, af) {
    //console.log(af[0][0]);
    var width = w, height = h, imageData = new Uint8ClampedArray(af[0][0]); 
  ...
  FeatTrainer.prototype.getGrayScaleMat = function (img, imageData) {  
